...
from openheron.provider import (
...
from openheron.openai_codex_llm import OpenAICodexLlm
...
class ProviderTests(unittest.TestCase):
    ...
    def test_openai_codex_runtime_is_supported(self) -> None:
        with patch("openheron.provider.importlib.util.find_spec", return_value=object()):
    ...
    def test_openai_codex_runtime_requires_oauth_cli_kit(self) -> None:
        ...
        with patch("openheron.provider.importlib.util.find_spec", side_effect=_find_spec):
            issue = validate_provider_runtime("openai_codex")
