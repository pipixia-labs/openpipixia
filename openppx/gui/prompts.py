...
DEFAULT_GUI_EXECUTOR_SYSTEM_PROMPT_PATH_ENV = "OPENPPX_GUI_EXECUTOR_SYSTEM_PROMPT_PATH"
DEFAULT_GUI_PLANNER_SYSTEM_PROMPT_PATH_ENV = "OPENPPX_GUI_PLANNER_SYSTEM_PROMPT_PATH"
